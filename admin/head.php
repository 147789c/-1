...
<li class="<?php echo checkIfActive('fanghei,jiami,MD5,app,yule')?>">
	<a href="javascript:void(0)" class="sidebar-nav-menu"><i class="fa fa-chevron-left sidebar-nav-indicator sidebar-nav-mini-hide"></i><i class="fa fa-user-circle-o sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">VIP功能</span></a>
	<ul>
<li>
	<a class="<?php echo checkIfActive("fanghei") ?>" href="./fang.php">
		防黑设置
	</a>
</li>
<li>
	<a class="<?php echo checkIfActive("jiami") ?>" href="./base64.php">
		base64
	</a>
</li>
<li>
