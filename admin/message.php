 ...
 <form action="./message.php?my=add_submit" method="post" class="form-horizontal" role="form">
   <div class="form-group">
	...
	<div class="form-group">
	 ...
	 <div class="col-sm-10"><select class="form-control" name="type"><option value="0">全部用户</option><option value="1">普通用户</option><option value="2">所有代理站长</option><option value="3">普通代理</option><option value="4">专业代理</option><option value="5">高级代理</option></select></div>
	</div><br/>
	<div class="form-group">
   ...
   <div class="form-group">
	...
	<div class="form-group">
	 ...
	 <div class="col-sm-10"><select class="form-control" name="type" default="';
		echo $row['type'];
		echo '"><option value="0">全部用户</option><option value="1">普通用户</option><option value="2">所有代理站长</option><option value="3">普通代理</option><option value="4">专业代理</option>on><option value="5">高级代理</option></select></div>
	</div><br/>
	<div class="form-group">
	 <label class="col-sm-2 control-label">通知内容</label>
	 <div class="col-sm-10"><textarea class="form-control" name="content" rows="5">';
